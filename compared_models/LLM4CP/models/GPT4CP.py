...
class GPT4CP(nn.Module):

    def __init__(self, gpt_type='gpt2', d_ff=768, d_model=768, gpt_layers=6,
                 pred_len=6, prev_len=24, use_gpu=1, gpu_id=2, mlp=0, res_layers=4,
                 K=1, UQh=2, UQv=2, BQh=2, BQv=2,
                 patch_size=4, stride=1, res_dim=128,
                 embed='timeF', freq='h', dropout=0.1):
        super(GPT4CP, self).__init__()
...
if __name__ == '__main__':
    ...
    model = GPT4CP(UQh=1, UQv=1, BQh=1, BQv=1).to(device)
